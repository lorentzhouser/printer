class printObject {
	...
	setRecommendedTimeSlot(slot) { this.recommendedTimeSlot = slot; }
	setUrgentTimeSlot(slot) { this.urgentTimeSlot = slot; }
	...
	getRecommmendedDevice() { return this.recommendedTimeSlot.device; }
	getUrgentDevice() { return this.urgentTimeSlot.device; }
	getRecommendedTime() { return this.recommendedTimeSlot.startTime; }
	getUrgentTime() { return this.urgentTimeSlot.startTime; }
	getHumanReadableRecommendedTime() { return printObject.getGenericHumanReadableDate(this.getRecommendedTime()); }
	getHumanReadableUrgentTime() { return printObject.getGenericHumanReadableDate(this.getUrgentTime()); }
	getSelectedReservation() {
		//maybe this should return a reservation object with all the necessary details?
		switch(Number(printObject.selectedReservation)) {
			case -1:
			return "none";
			case 0:
			return {startTime: this.getHumanReadableRecommendedTime(), device: this.getRecommmendedDevice()};
			case 1:
			return {startTime: this.getHumanReadableUrgentTime(), device: this.getUrgentDevice()};
			default:
	...
	getSelectedReservationValue() {
		switch(Number(printObject.selectedReservation)) {
			case 0:
			return {startTime: this.getRecommendedTime(), device: this.getRecommmendedDevice()};
			case 1:
			return {startTime: this.getUrgentTime(), device: this.getUrgentDevice()};
			default:
			return -1;
		}
	}
