...
gcodeProcessorWorker.onmessage = function (e) {
	if ("progress" in e.data) {
		...
		const filamentLength = e.data.result['filamentUsage'];
		currentPrintObject.setDuration(printEstimate);
		currentPrintObject.setFilamentLength(filamentLength);
...
Http.onreadystatechange = (e) => {
	...
	currentPrintObject.setRecommendedTimeSlot(responseObj.recommendJobStart);
	currentPrintObject.setUrgentTimeSlot(responseObj.urgentJobStart);
