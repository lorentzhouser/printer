<template>
    <div class="ReservationModal" v-bind:class="{ Visible: visibilty }">
      <div class="ReservationModalContent">
        <div class="ModalTitle header3">New Booking</div>

        <div class="FormContainer">

          <div class="ModalRow">
            <div class="ModalColumn subtitle1">Filename</div>
            <input class="ModalColumn modalInput" placeholder="filename / description" v-model="filename">
          </div>
          ...
          <div class="ModalRow">
            ...
            <div class="ModalColumn">
              <div class="ModalRow">
                ...
                <!-- <input class="modalInput" ref="printTime" v-model="humanReadablePrintTime" placeholder="2 hour, 20 minuttes" autofocus> -->
